...
public class ParalleHBaseQuery {
	...
	private static CountDownLatch latch = new CountDownLatch(BUCHET_SIZE);
	...
	public static void main(String[] args)throws Exception{
		...
		String qualifierName = "ts";
		String startRow = "20180626120000";
		String endRow = "20180627130000";
		int num = 1000;
		...
		if (isComplexQuery) {
			...
			//String[] value1 = {"1","=","v","url","[]"};
			String[] value2 = {"3","!=","v","ts"," "};
